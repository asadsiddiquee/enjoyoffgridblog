...
export default function Post({ postData, allPostData }) {
  ...
  return (
    <Layout>
      <div className="container mx-auto sm:grid grid-cols-6 gap-6 md:pl-16">
        <div className="col-start-1 col-end-5 px-2 py-4 md:px-8 container mx-auto  ">
          ...
          <div>
            ...
            <div className="font-out text-sm md:text-base py-2 mb-4 xl:text-center">
              <Link href="/">
