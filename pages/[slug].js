  ...
  return (
    <Layout>
      <div className="container mx-auto sm:grid grid-cols-6 gap-6">
        <div className="col-start-1 col-end-5 px-2 py-4 md:px-8 md:ml-16 ">
          <Head>
          ...
          <div>
            ...
            <div className="font-out py-2 mb-4">
              <Link href="/">
              ...
              <p className="inline-block font-thin border-b border-dashed border-black   text-slate-500">
                {postData.title}
              </p>
            </div>
