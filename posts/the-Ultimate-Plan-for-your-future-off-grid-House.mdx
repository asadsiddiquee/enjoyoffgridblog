...
- **Solar Power**
  ...
  is one of the most popular renewable energy sources. The Sun is the main energy
  source for our whole galaxy, it emits energy in form of light. Normally plants
  can absorb that energy but we cannot. We invented a photovoltaic cell that can
  convert the solar radiant light into electricity and we call it a solar panel.
